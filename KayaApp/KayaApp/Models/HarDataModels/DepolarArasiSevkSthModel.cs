...
{
    public class DepolarArasiSevkSthModel : BaseViewModel
    {
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (DepolarArasiTransferPage.DepArTRFVMZ != null)
                //{
                //    DepolarArasiTransferPage.DepArTRFVMZ.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
