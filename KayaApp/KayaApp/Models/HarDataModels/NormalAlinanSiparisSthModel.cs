...
{
    public class NormalAlinanSiparisSthModel : BaseViewModel
    {
        ...
        public double sth_temp_vergi { get; set; }
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (NormalAlinanSiparis.ORDERVMzz != null)
                //{
                //    NormalAlinanSiparis.ORDERVMzz.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
