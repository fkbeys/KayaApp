...
{
    public class DepolarArasiNakliyeSthModel : BaseViewModel
    {
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (DepolarArasiNakliyePage.DepArNakVMZZZ != null)
                //{
                //    DepolarArasiNakliyePage.DepArNakVMZZZ.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
