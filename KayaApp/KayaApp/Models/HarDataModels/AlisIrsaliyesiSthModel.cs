...
{
    public class AlisIrsaliyesiSthModel : BaseViewModel
    {
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (AlisIrsaliyesiPage.alisIrsaliyeVMZ != null)
                //{
                //    AlisIrsaliyesiPage.alisIrsaliyeVMZ.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
