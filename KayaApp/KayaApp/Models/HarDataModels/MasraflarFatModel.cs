...
{
    public class MasraflarFatModel : BaseViewModel
    {
        ...
        public string Gosterge_fat_meblag
        {
            ...
            set
            {
                ...
                //if (KasaMasrafFisi.MONEYVMMasrafzz != null)
                //{
                //    KasaMasrafFisi.MONEYVMMasrafzz.CalculateSum.Execute(_Gosterge_fat_meblag);
                //}
        ...
        public string fat_islem_baglanti { get; set; }

        public string fat_doviz_adi { get; set; }
