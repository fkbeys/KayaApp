...
{
    public class ProformaSthModel : BaseViewModel
    {
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (ProformaAlinanSiparis.PROFORMAVMzz != null)
                //{
                //    ProformaAlinanSiparis.PROFORMAVMzz.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
