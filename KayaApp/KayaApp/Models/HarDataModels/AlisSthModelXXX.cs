...
{
    public class AlisSthModelXXX : BaseViewModel
    {
        ...
        public string sth_miktar_gosterge
        {
            ...
            set
            {
                ...
                INotifyPropertyChanged("sth_miktar_gosterge");
            }
        }
        ...
        public string sth_fiyat_gosterge
        {
            ...
            set
            {
                ...
                INotifyPropertyChanged("sth_fiyat_gosterge");
            }
        }
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (BuyPage.BUYVMzz != null)
                //{
                //    BuyPage.BUYVMzz.CalculateSum.Execute(_sth_tutar_gosterge);
                //}

                INotifyPropertyChanged("sth_tutar_gosterge");
            }
        }
