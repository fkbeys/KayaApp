...
namespace KayaApp.Models
{
    public class GeneralSTH
    {
        ...
        private double _sth_tutar_vergili;

        public double sth_tutar_vergili
        {
            get { return Math.Round(sth_tutar + sth_vergi, 2); }
            set { _sth_tutar_vergili = Math.Round(sth_tutar + sth_vergi, 2); }
        }
