...
{
    public class SayimSonuclariSthModel : BaseViewModel
    {
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (SayimSonuclariPage.SayimSonVMZ != null)
                //{
                //    SayimSonuclariPage.SayimSonVMZ.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
        ...
        public int sth_reyon_kodu_sayim { get; set; }
