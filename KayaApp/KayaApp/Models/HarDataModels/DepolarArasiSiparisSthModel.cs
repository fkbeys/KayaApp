...
{
    public class DepolarArasiSiparisSthModel : BaseViewModel
    {
        ...
        public string sth_tutar_gosterge
        {
            ...
            set
            {
                ...
                //if (DepolarArasiSiparisPage.DepolarAraSiparisVMZ != null)
                //{
                //    DepolarArasiSiparisPage.DepolarAraSiparisVMZ.CalculateSum.Execute(_sth_tutar_gosterge);
                //}
